...
class Ray:
    ...
    def cast(self):
        ...
        while (nextHorizontalX <= window_widht and nextHorizontalX >= 0 and nextHorizontalY <= window_height and nextHorizontalY >= 0):
        ...
        # while it is inside the window
        while (nextVerticalX <= window_widht and nextVerticalX >= 0 and nextVerticalY <= window_height and nextVerticalY >= 0):
        ...
        self.distance *= math.cos(self.player.a - self.rayAngle)
